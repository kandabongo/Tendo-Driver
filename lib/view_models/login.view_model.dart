...
class LoginViewModel extends MyBaseViewModel with QrcodeScannerTrait {
  ...
  LoginViewModel(BuildContext context) {
    ...
    final countryCoe = PhoneUtilService.countryCode ?? "us";
    this.selectedCountry = Country.parse(countryCoe);
    //
    if (kDebugMode) {
      emailTEC.text = "driver@demo.com";
  ...
  void openForgotPassword() {
    Navigator.of(viewContext).pushNamed(AppRoutes.forgotPasswordRoute);
  }
