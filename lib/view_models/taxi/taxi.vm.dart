...
class TaxiViewModel extends MyBaseViewModel {
  ...
  void initialise() async {
    ...
    //init assignment listener
    initDirectAssignmentListener();
  }

  checkForOnGoingTrip() async {
    onGoingOrderTrip = await onGoingTaxiBookingService.getOnGoingTrip();
    await onGoingTaxiBookingService.loadTripUIByOrderStatus();
    if (onGoingOrderTrip != null) {
      DriverNotificationWebsocketService().disconnectAssignment();
    } else {
      initDirectAssignmentListener();
    }
  }
