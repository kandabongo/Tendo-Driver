...
import 'package:fuodz/views/pages/wallet/remittance_payment.page.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    //
    case AppRoutes.remittancePaymentRoute:
      return MaterialPageRoute(
        settings: RouteSettings(name: AppRoutes.remittancePaymentRoute),
        builder: (_) => RemittancePaymentPage(settings.arguments as double),
      );
